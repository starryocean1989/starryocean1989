...
⚠️ 重要说明：
本组件已移除 PyQt6-QScintilla 支持，避免 PySide6/PyQt6 混用问题。
推荐使用 monaco_editor_widget.py（基于 PySide6-WebEngine）获得更强大的编辑功能。

降级机制：
如果 Monaco Editor 不可用，此组件提供基础编辑功能作为后备方案。
"""
