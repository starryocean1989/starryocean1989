...
class SymbolSearchWidget(QComboBox):
    ...
    def _on_text_changed(self, text: str):
        ...
        try:
            ...
            if matched and len(text.strip()) > 0 and line_edit.hasFocus():
                self.showPopup()
