# -*- coding: utf-8 -*-
"""Cron 调度实现，默认使用 native_scheduler 作为执行后端."""
...
from backend.infrastructure.native.native_scheduler import NativeScheduler, SCHEDULER_AVAILABLE
...
class NativeCronScheduler:
    """支持 interval、cron、date 三类触发的轻量调度器."""
    ...
    def __init__(
        ...
        *,
        ...
        self._native = NativeScheduler(executor_factory=NativeThreadPool)
