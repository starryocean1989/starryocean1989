...
if __name__ == "__main__":
    ...
    [
        ...
        shutil.copy(
            ...
            os.path.join(os.path.join(bpath, "debug_version_dependencies"), s),
        ...
        for s in os.listdir(os.path.join(bpath, "debug_version_dependencies"))
    ...
    exec_path = (
        ...
        os.path.join(
            ...
            "build-TdxTradeServer-Desktop_Qt_" + qt_version + "_MSVC2015_32bit-Debug",
